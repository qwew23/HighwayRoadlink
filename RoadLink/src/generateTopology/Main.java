...
//				"E:/地图数据/secret/road2018q2/zhejiang2/浙江2.mid",
//				"E:/地图数据/secret/road2018q2/zhejiang2/浙江2.mif",
//				"E:/地图数据/level2/level2/zhejiang2/other/PNamezhejiang2.mid",
//				"E:/地图数据/level2/level2/zhejiang2/index/POIzhejiang2.mid",
//				"E:/地图数据/secret/road2018q2/zhejiang2/road/R_LNamezhejiang2.mid",
//				"E:/地图数据/secret/road2018q2/zhejiang2/road/R_Namezhejiang2.mid");
		HashMap<String, RoadLink> id_Roadlink = Main.getTopology_ID_RoadLink_RoadName_Station(
				"E:/地图数据/secret/road2018q2/zhejiang_all/zhejiang_all.mid",
				"E:/地图数据/secret/road2018q2/zhejiang_all/zhejiang_all.mif",
				"E:/地图数据/level2/level2/zhejiang_all/other/PNamezhejiang_all.mid",
				"E:/地图数据/level2/level2/zhejiang_all/index/POIzhejiang_all.mid",
				"E:/地图数据/secret/road2018q2/zhejiang_all/road/R_LNamezhejiang_all.mid",
				"E:/地图数据/secret/road2018q2/zhejiang_all/road/R_Namezhejiang_all.mid");
		try {
			BufferedWriter writer=new BufferedWriter(new FileWriter("E:/work/outTopology/zhejiangAllTopology.csv"));
	...
	public static void readCMid(String path,Map<Integer,String> idWithPointMessage){
		...
		try{
			...
			reader.close();
//			System.out.println("Rzhejiang_all.mid:"+lineId);
		}catch(Exception e){
			e.printStackTrace();
		}
	}
	...
	public static HashMap<String, RoadLink> getTopology_ID_RoadLink_RoadName_Station(String mid_file_path,
		...
		try {
			String line = null;
			String Czhejiang2Mid="E:/地图数据/secret/road2018q2/zhejiang_all/road/Czhejiang_all.mid";
			String Czhejiang2Mif="E:/地图数据/secret/road2018q2/zhejiang_all/road/Czhejiang_all.mif";
